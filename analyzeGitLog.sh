...
git log --since="2021-01-01 01:30:00" --until="2023-09-20 01:30:00" --pretty=format: --name-only | sort | uniq -c  | sed "s/.*pom.xml//g" | sed "s/.*drone.yml//g" | sed "s/.*spring.factories//g" | sort -rg | head -20
