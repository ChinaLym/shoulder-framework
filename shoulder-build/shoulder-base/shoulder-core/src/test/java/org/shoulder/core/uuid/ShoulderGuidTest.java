...
public class ShoulderGuidTest {
    ...
    /**
     * 生成次数（默认 1亿次，低性能机器适当调低，否则将过于卡顿或导致测试结果不准确）
     */
    ...
    public void timer_nextId() {
        ...
        System.out.println("HIGH PRESS TEST: " + GENERATE_NUM + " generated by 1 threads cost " + end + " ms");
    }
    ...
    /**
     * 【无重复】单线程，每次获取 getNum 个，总共获取 GENERATE_NUM 个，测试是否产生重复 id
     */
    @Test
    public void noRepeat_nextIds() {
        BitSet bitSet = new BitSet(GENERATE_NUM);
    ...
    public void timer_nextId_threads() throws InterruptedException {
        ...
        long start = System.currentTimeMillis();
        finishLatch.await();
        System.out.println("HIGH PRESS TEST: " + GENERATE_NUM + " generated by " + totalThreadNum + " threads cost " +
    ...
    public void noRepeat_threads() throws InterruptedException {
        ...
        System.out.println("HIGH PRESS TEST: " + realGen + " generated by " + totalThreadNum + " threads cost " + end +
            " ms");
