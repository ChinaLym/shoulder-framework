...
public class ShoulderGuidTest {
    ...
    public void noRepeat_nextId() {
        ...
        for (int i = 0; i < GENERATE_NUM; i++) {
            ...
            Assertions.assertTrue(id > lastId, "生产的 id 非单调递增"); // 断言递增
            lastId = id;
        }
        System.out.println(bitSet.cardinality());
        Assertions.assertEquals(GENERATE_NUM, bitSet.cardinality());
    }
    ...
    public void noRepeatAndIncreasing_nextIds() {
        ...
        for (int i = 0; i < GENERATE_NUM; ) {
            ...
            for (long id : ids) {
                ...
                bitSet.set(pressedId);
                Assertions.assertTrue(id > lastId, "生产的 id 非单调递增");
                lastId = id;
            }
            i += getNum;
        }
        ...
        Assertions.assertEquals(GENERATE_NUM, bitSet.cardinality(), "存在重复id");
    }
